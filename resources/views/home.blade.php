...
@section('content')
                    ...
                    <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
                      <div class="d-flex flex-wrap justify-content-xl-between">
                        ...
                        <div class="d-flex border-md-right flex-grow-1 align-items-center justify-content-center p-3 item">
                          <i class="mdi mdi-account-tie-voice me-3 icon-lg text-danger"></i>
                          <div class="d-flex flex-column justify-content-around">
                            <small class="mb-1 text-muted">Total Leads</small>
                            <h5 class="me-2 mb-0">{{$leads}}</h5>
                          </div>
                        </div>
                        <div class="d-flex border-md-right flex-grow-1 align-items-center justify-content-center p-3 item">
                          ...
                          <div class="d-flex flex-column justify-content-around">
                            ...
                            <h5 class="me-2 mb-0">{{$clients}}</h5>
                          </div>
                        </div>
                        <div class="d-flex border-md-right flex-grow-1 align-items-center justify-content-center p-3 item">
                          <i class="mdi mdi-account-group me-3 icon-lg text-warning"></i>
                          <div class="d-flex flex-column justify-content-around">
      ...
      const myChart = new Chart(ctx, {
        type: 'line',
          data: {
          labels: ["Januaray", "Feb", "March",
          "April", "May", "May", "June", "July", "August", "Sep" , "Oct", "Nov", "Dec"],
          datasets: [{
            label: 'Last Month',
